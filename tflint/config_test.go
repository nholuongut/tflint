...
import (
	...
	"github.com/nholuongut/tflint/terraform"
)
...
config {
	...
	ignore_module = {
		"github.com/nholuongut/example-module" = true
	}
...
func TestMerge(t *testing.T) {
	...
	config := &Config{
		...
		ForceSet:          true,
		IgnoreModules: map[string]bool{
			"github.com/nholuongut/example-1": true,
			"github.com/nholuongut/example-2": false,
		},
		Varfiles:          []string{"example1.tfvars", "example2.tfvars"},
	...
	tests := []struct {
		...
		},
		{
			...
			other: &Config{
				...
				ForceSet:          true,
				IgnoreModules: map[string]bool{
					"github.com/nholuongut/example-2": true,
					"github.com/nholuongut/example-3": false,
				},
