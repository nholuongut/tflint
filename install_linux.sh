...
get_latest_release() {
  ...
  curl --fail -sS "${headers[@]}" "https://api.github.com/repos/nholuongut/tflint/releases/latest" | # Get latest release from GitHub api
...
curl --fail -sS -L -o "${download_zip}" "https://github.com/nholuongut/tflint/releases/download/${version}/tflint_${os}.zip"
