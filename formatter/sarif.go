...
func (f *Formatter) sarifPrint(issues tflint.Issues, appErr error) {
	...
	run := sarif.NewRunWithInformationURI("tflint", "https://github.com/nholuongut/tflint")
	...
	errRun := sarif.NewRunWithInformationURI("tflint-errors", "https://github.com/nholuongut/tflint")
