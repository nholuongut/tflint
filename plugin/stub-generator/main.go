...
func main() {
	...
	execCommand("go", "build", "-o", "../test-fixtures/plugins/github.com/nholuongut/tflint-ruleset-bar/0.1.0/tflint-ruleset-bar"+fileExt(), "./sources/bar/main.go")
	execCommand("cp", "../test-fixtures/plugins/github.com/nholuongut/tflint-ruleset-bar/0.1.0/tflint-ruleset-bar"+fileExt(), "../test-fixtures/locals/.tflint.d/plugins/github.com/nholuongut/tflint-ruleset-bar/0.1.0/tflint-ruleset-bar"+fileExt())
