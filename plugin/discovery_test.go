	...
	plugin, err := Discovery(&tflint.Config{
		Plugins: map[string]*tflint.PluginConfig{
			...
			"bar": {
				Name:    "bar",
				Enabled: false,
				Source:  "github.com/nholuongut/tflint-ruleset-bar",
				Version: "0.1.0",
			},
		},
	})
	...
	_, err = Discovery(&tflint.Config{
		Plugins: map[string]*tflint.PluginConfig{
			"foo": {
				Name:    "foo",
				Enabled: true,
				Source:  "github.com/nholuongut/tflint-ruleset-foo",
				Version: "0.1.0",
			},
		},
	})
...
func Test_FindPluginPath(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			Expected: filepath.Join(PluginRoot, "github.com/nholuongut/tflint-ruleset-bar", "0.1.0", "tflint-ruleset-bar"+fileExt()),
		},
	}
...
func Test_FindPluginPath_locals(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			Expected: filepath.Join(localPluginRoot, "github.com/nholuongut/tflint-ruleset-bar", "0.1.0", "tflint-ruleset-bar"+fileExt()),
		},
	}
...
func Test_FindPluginPath_envVar(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			Expected: filepath.Join(dir, "github.com/nholuongut/tflint-ruleset-bar", "0.1.0", "tflint-ruleset-bar"+fileExt()),
		},
	}
...
func Test_FindPluginPath_pluginDirConfig(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			Expected: filepath.Join(globalConfig.PluginDir, "github.com/nholuongut/tflint-ruleset-bar", "0.1.0", "tflint-ruleset-bar"+fileExt()),
		},
	}
